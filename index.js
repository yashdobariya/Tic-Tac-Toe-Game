...
const CheckPlayerWin = (event,ind1,ind2) => {
    ...
    if ( !cell_Data_Record[0].includes("") && cell_Data_Record[0][0] === cell_Data[1].innerHTML && cell_Data_Record[0][0] === cell_Data[2].innerHTML) {
        win_Data.innerHTML = "You Win";
        playerWin = true;
    }
    
    else if (cell_Data_Record[1][0] == cell_Data[4].innerHTML && cell_Data_Record[1][0] == cell_Data[5].innerHTML) {
        win_Data.innerHTML = "You Win";
        playerWin = true;
    }
    ...
    else if (cell_Data_Record[0][0] == cell_Data[3].innerHTML && cell_Data_Record[0][0] == cell_Data[6].innerHTML) {
        win_Data.innerHTML = "You Win";
        playerWin = true;
    }
    else if (cell_Data_Record[0][1] == cell_Data[4].innerHTML && cell_Data_Record[0][1] == cell_Data[7].innerHTML) {
        win_Data.innerHTML = "You Win";
        playerWin = true;
    }
    else if (cell_Data_Record[0][2] == cell_Data[5].innerHTML && cell_Data_Record[0][2] == cell_Data[8].innerHTML) {    
        win_Data.innerHTML = "You Win";
        playerWin = true;
    }
    else if (cell_Data_Record[0][0] == cell_Data[4].innerHTML && cell_Data_Record[0][0] == cell_Data[8].innerHTML) {    
        win_Data.innerHTML = "You Win";
        playerWin = true;
    }
    else if (cell_Data_Record[0][2] == cell_Data[4].innerHTML && cell_Data_Record[0][2] == cell_Data[6].innerHTML) {    
        win_Data.innerHTML = "You Win";
        playerWin = true;
    }
